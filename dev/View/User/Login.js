(function () {
    ...
    function LoginUserView() {
        ...
        this.domains = ko.observable([
            {value: "dikrong.iitg.ernet.in", text: "Dikrong"},
            {value: "disang.iitg.ernet.in", text: "Disang"},
            {value: "naambor.iitg.ernet.in", text: "Naambor"},
            {value: "tamdil.iitg.ernet.in", text: "Tamdil"},
            {value: "teesta.iitg.ernet.in", text: "Teesta"},
        ]);
        ...
        this.submitCommand = Utils.createCommand(this, function () {
            ...
            var email = Utils.trim(this.email());
            email = email.split('@')[0];

            console.log(this.domain());
            this.email(email + '@' + this.domain().value);
